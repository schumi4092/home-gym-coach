        ...
        {RPE_OPTIONS.map((value) => {
          ...
          return (
            <button
              ...
              style={{ width: 38, height: 28, fontSize: 12, fontWeight: 700, borderRadius: 7, cursor: "pointer", border: active ? "none" : `1px solid ${T.border}`, background: active ? color : T.bg3, color: active ? T.bg : T.t3, transition: "all 0.12s", lineHeight: 1, display: "flex", alignItems: "center", justifyContent: "center" }}
            >
              {value}
            </button>
          );
